...
# ✅ URLs
url = "https://balmer.finkraft.ai/auth/signin"
...
def test_login():
    ...
    try:
        ...
        workspace_name = "DHI (INDIA) WATER & ENVIRONMENT"
        ...
        workspace_select = "Central pollution control board"
        ...
        file_path = "/Users/mac/Desktop/partner/Login/INV NUM Balmer.csv"  # Replace with the actual file path
